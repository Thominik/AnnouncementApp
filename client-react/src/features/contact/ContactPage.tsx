        ...
        <Container>
            ...
            >
                <Grid item xs={12} sm={12} justifyContent='center' alignItems='center'>
                    ...
                    <Typography variant='h5' justifyContent='center' alignItems='center' display='flex'>Spec.pl</Typography>
                ...
                <Grid container item xs={12} sm={6} direction='column' justifyContent='center' alignItems="center"
                    ...
                    <Typography variant='h5'>support@spec.pl</Typography>
                </Grid>
                <Grid container item xs={12} sm={6} direction='column' justifyContent='center' alignItems="center"
                      sx={{mb: 5}}>
                    <IconButton><Facebook style={{width: '90px', height: '90px'}}></Facebook></IconButton>
                    <Typography variant='h5'>facebook.com/specpl</Typography>
                </Grid>
                <Grid container item xs={12} sm={6} direction='column' justifyContent='center' alignItems="center"
                      sx={{mb: 5}}>
                    <IconButton><Twitter style={{width: '90px', height: '90px'}}></Twitter></IconButton>
                    <Typography variant='h5'>twitter.com/specpl</Typography>
                </Grid>
                <Grid container item xs={12} sm={6} direction='column' justifyContent='center' alignItems="center"
                      sx={{mb: 5}}>
