    ...
    return (
        <Grid container spacing={6}>
                ...
                <TableContainer sx={{mt: 5, ml: 'auto', mr: 'auto'}}>
                    <Table sx={{ml: 7}}>
                        <TableBody>
                            ...
                            <TableRow>
                                <TableCell style={{borderBottom:"none"}} align='right'><Icon><Category color='primary'></Category></Icon></TableCell>
                                <TableCell style={{borderBottom:"none"}} align='left'>{announcement.industry}</TableCell>
                            </TableRow>
                            <TableRow>
            ...
            <Grid item xs={8}>
                ...
                <Typography color='primary.main' sx={{ mb: 11.7, mr: 5}} textAlign='end' variant='h6'>{announcement.industry}</Typography>
                <Divider sx={{mb: 8}} />
